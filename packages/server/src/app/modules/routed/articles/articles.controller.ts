...
export class ArticlesController {
  ...
  async getLastArticles(config: AppConfigService, @optional() @ctx(QUERY_PARAMS) queryParams: any = {}) {
  ...
  async getArticle(
    ...
    @ctx(PATH_PARAMS) pathParams: any,
    @optional() @ctx(QUERY_PARAMS) queryParams: any = {}
  ) {
