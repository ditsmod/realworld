...
import { HttpHandler, HttpInterceptor, Req, Status } from '@ditsmod/core';
...
export class ValidationInterceptor implements HttpInterceptor {
  constructor(private req: Req, private validationMeta: ValidationRouteMeta, private assert: AssertService) {}
  ...
  protected validateRequestBody() {
    ...
    if (!this.req.body) {
      ...
      throw new CustomError({ msg1: serverMsg.missingRequestBody, status: Status.BAD_REQUEST });
    }
